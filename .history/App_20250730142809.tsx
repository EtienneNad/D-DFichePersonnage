...
const genererDe = (nombreDeFace: number) => {
  const nouveauNombre = Math.floor(Math.random() * nombreDeFace) + 1;
  ...
  return (
    ...
    <TouchableOpacity style={styles.bouton} onPress={() => genererDe(20)}>
            <Text style={styles.boutonTexte}>
              {randomNumber !== null ? `Nombre: ${randomNumber}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bouton} onPress={() => genererDe(12)}>
            <Text style={styles.boutonTexte}>
              {randomNumber !== null ? `Nombre: ${randomNumber}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
