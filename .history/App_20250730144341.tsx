  ...
  return (
    ...
    <TouchableOpacity style={styles.bouton} onPress={() => genererDeVingt()}>
            <Text style={styles.boutonTexte}>
              {deVingtFaces !== null ? `Nombre: ${deVingtFaces}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bouton} onPress={() => genererDeDouze()}>
            <Text style={styles.boutonTexte}>
              {deDouzeFaces !== null ? `Nombre: ${deDouzeFaces}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bouton} onPress={() => genererDeDix()}>
            <Text style={styles.boutonTexte}>
              {deDixFaces !== null ? `Nombre: ${deDixFaces}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bouton} onPress={() => genererDeHuit()}>
            <Text style={styles.boutonTexte}>
              {deHuitFaces !== null ? `Nombre: ${deHuitFaces}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bouton} onPress={() => genererDeSix()}>
            <Text style={styles.boutonTexte}>
              {deSixFaces !== null ? `Nombre: ${deSixFaces}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bouton} onPress={() => genererDeQuatre()}>
            <Text style={styles.boutonTexte}>
              {deQuatreFaces !== null ? `Nombre: ${deQuatreFaces}` : 'Générer un nombre'}
            </Text>
          </TouchableOpacity>
        </ScrollView>
  );
