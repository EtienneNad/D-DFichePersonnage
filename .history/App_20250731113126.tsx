...
const recupererRace = (id: number): string => {
...
return (
  ...
  <View style={styles.personnageContainer}>
    ...
    <Text style={styles.personnageTexte}>Classe : {personnages[0].classe_id}</Text>
    <Text style={styles.personnageTexte}>Race : {personnages[0].race_id}</Text>
