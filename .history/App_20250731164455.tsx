    ...
    <ScrollView contentContainerStyle={[styles.scrollContent, themeActuel === 'sombre' && { backgroundColor: '#222' }]}>
      ...
      <View style={styles.dropdownContainer}>
        <Dropdown
          ...
          containerStyle={{ backgroundColor: themeActuel === 'sombre' ? 'darkgray' : 'darkgray' }}
          itemTextStyle={{ color: themeActuel === 'sombre' ? 'black' : '#000' }}
          placeholderStyle={{ color: themeActuel === 'sombre' ? 'white' : '#999' }}
          selectedTextStyle={{ color: themeActuel === 'sombre' ? 'gray' : '#000' }}
