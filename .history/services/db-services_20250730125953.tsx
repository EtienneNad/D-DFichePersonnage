...
export const ajouterPersonnage = async (db: SQLiteDatabase, mesPersonnages: MesPersonnages[]) => {
  await db.transaction(async personnage => {
    ...
    (nomPersonnage, age, sexe, taille, poids, classe, race, niveau, alignement, pointExp, pvMax, pvActuel, force, bonusForce, dexterite, bonusDexterite, constitution, bonusConstitution, intelligence, bonusIntelligence, sagesse, bonusSagesse, charisme, bonusCharisme, vitesse, attaque, defense, sort, équipement, apparence, histoire, Aliés, tresor, notes, notesSort) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`;
    ...
    for (const personnage of mesPersonnages) {
      await db.executeSql(insertQuery, [
        ...
        personnage.pvActuel,
        personnage.force,
        personnage.bonusForce,
        personnage.dexterite,
        personnage.bonusDexterite,
        personnage.constitution,
        personnage.bonusConstitution,
        personnage.intelligence,
        personnage.bonusIntelligence,
        personnage.sagesse,
        personnage.bonusSagesse,
        personnage.charisme,
        personnage.bonusCharisme,
        personnage.vitesse,
        personnage.attaque,
        personnage.defense,
        personnage.sort,
